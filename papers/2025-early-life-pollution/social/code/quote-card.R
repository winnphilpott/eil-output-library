...
#
#  Run (from REPO ROOT):
#    Rscript papers/2025-early-life-pollution/social/code/quote-card.R
#    -> writes social/assets/early-life-quote-card.png
...
OUT_PATH <- "papers/2025-early-life-pollution/social/assets/early-life-quote-card.png"
