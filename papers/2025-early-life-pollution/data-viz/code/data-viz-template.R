...
#
#  Run (from this paper's data-viz/ folder):  Rscript code/data-viz-template.R
#        -> writes figures/fig1.png
...
# Source the house theme + palette. Path is relative to this paper's
# data-viz/ folder (the working dir when you run `Rscript code/...`).
source("../../../formats/data-viz/eil-theme.R")

OUT_PATH <- "figures/fig1.png"
CARD_PATH <- "figures/fig1-card.png"   # standalone/social variant
