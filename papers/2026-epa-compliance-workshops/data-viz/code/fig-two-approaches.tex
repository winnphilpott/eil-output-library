...
%
%  This is a faithful reproduction of fig-two-approaches_1_cropped.png.
%  Colours, type (Source Sans 3), and layout were measured off that PNG.
%
%  BUILD (produces a vector PDF next to this file):
%      pdflatex fig-two-approaches.tex
%  then copy the PDF to ../figures/ if you point the .qmd at it:
%      cp fig-two-approaches.pdf ../figures/fig-two-approaches.pdf
%
