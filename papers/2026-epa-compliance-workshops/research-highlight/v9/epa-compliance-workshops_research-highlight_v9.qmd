...
\begin{wrapfigure}{r}{3.1in}
  \vspace{-\intextsep}
  \centering
  \includegraphics[width=3.1in]{../../data-viz/figures/fig-two-approaches_1_cropped.png}
\end{wrapfigure}
...
\noindent A null result for one program is not a verdict on compliance assistance everywhere. Rather, \textbf{this study exposes the importance of rigorous program evaluation}. Regulators could partner with interested researchers to phase in new programs and measure their effects --- turning an ordinary rollout into a genuine test of what works, much as this study did.
