...
\textbf{Offering polluting facilities free help to follow the rules doesn't make them more likely to follow them.} New research studying hundreds of facilities that were offered free compliance assistance workshops found that the program didn't reduce violations.
}
\end{bottomline}
...
\noindent \textbf{Violations did fall at the facilities that attended, but the workshops were not the reason.} Comparing before and after their training shows a 40 to 50 percent drop, but violations at these plants were already falling before the program trained anyone.
