...
\noindent If free guidance doesn't change behavior, \textbf{the barriers to compliance likely lie in the costs, capacity, and incentives that shape how facilities operate day to day, not a lack of know-how.} The study suggests that the facilities are less like confused actors waiting for help than ones weighing whether compliance is worth it.

\vspace{5pt}
\subhead{Enforcement is the tested alternative}
\noindent \textbf{The natural alternative to compliance assistance is traditional oversight, which past evidence suggests \textit{does} curb violations.} Enforcement budgets are already shrinking; if assistance draws scarce money and staff away from them, compliance could slip rather than improve. 
...
\begin{center}
\begin{tcolorbox}[enhanced, width=0.9\linewidth, arc=4pt, outer arc=4pt,
  boxrule=0.5pt, colframe=faint, colback=white,
