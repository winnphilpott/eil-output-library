...
\noindent The stakes are practical, not academic. Buoyed by that apparent success, the EPA has moved to expand the program to other states. Scaling a program that doesn't work only wastes more public money and leaves more pollution unaddressed. The lesson is not that assistance can never help; this is one program, and small benefits can't be ruled out. The point is that \textbf{such programs should be rigorously tested before they replace tools already known to work}.
