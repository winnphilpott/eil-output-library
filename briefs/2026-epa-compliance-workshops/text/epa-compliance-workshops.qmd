...
\colhead{Funding}
{\impcolsize Given scarce funding for the EPA enforcement office, programs need to actually work. This study indicates \brieflink{compliance assistance may not be as effective as previously thought}.\par}
\end{minipage}\hfill
\begin{minipage}[t]{0.310\linewidth}
...
\begin{minipage}[t]{0.310\linewidth}
\colhead{Oversight}
{\impcolsize The EPA does not systematically collect data on compliance assistance activities, according to a 2020 report from the Government Accountability Office, and \brieflink{this study underscores the need for more deliberate program evaluation}.\par}
\end{minipage}
