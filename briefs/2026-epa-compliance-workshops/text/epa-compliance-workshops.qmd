...
\briefcitation{Paper authored by Paul J. Ferraro \& Jay P. Shimshack \textperiodcentered{} *Journal of Policy Analysis and Management*, (2026)}
...
\vspace{0pt}
\figtitle{Violations per facility, 2014--2019} \textperiodcentered{} {Source: Ferraro \& Shimshack (2026).}
...
\colhead{Funding}
{\impcolsize Given scarce funding for the EPA enforcement office, programs need to actually work. This study indicates **compliance assistance may not be as effective as previously thought**.\par}
\end{minipage}\hfill
\begin{minipage}[t]{0.310\linewidth}
\colhead{Alternatives}
{\impcolsize The **trade-offs of different policies should be weighed as the EPA plans future programs**. Assistance is not proven to be as effective as inspections, though that is not to say they'll never be effective.\par}
\end{minipage}\hfill
\begin{minipage}[t]{0.310\linewidth}
\colhead{Oversight}
{\impcolsize The EPA does not systematically collect data on compliance assistance activities, according to a 2020 report from the GOvernment Accountability Office, and **this study underscores the need for more deliberate program evaluation**.\par}
\end{minipage}
