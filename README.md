...
4. **Press Release** Think about what a reporter needs to know to decide whether or not they want to explore or write about this paper. Think about taking it a step further than the social media output, but keeping it concise.
