...
3. **Data Visualization** Identify one (two if absolutely necessary) figure from the paper that gets the central point across. Verify with PIs that this is the idea we want to frame our communication around. ALSO SEE IF YOU HAVE ACCESS TO THE DATA THEMSELF or if we're just doing a visual recreation.
